...
export default function ProductCard({ 
  ...
  return (
    <TouchableOpacity activeOpacity={0.7} onPress={onPress} className="w-full h-auto shadow">
      <Card className="overflow-hidden rounded-t-full rounded-b-[3458px] p-4 items-center">
        ...
        <CardContent className="p-2">
          <View className="flex-col gap-1">
            <Text className="text-xl font-semibold text-center" numberOfLines={2}>
              {title}
            </Text>
            ...
            <Text className="text-xs text-red-500 text-center font-medium" numberOfLines={2}>
              {category}
            </Text>
            ...
            <View className="flex-col items-center justify-between">
              ...
              {discount && (
                <Badge variant="destructive" className="px-1 py-0.5">
                  <Text className="text-xs text-yellow-200">{discount}% off</Text>
                </Badge>
              )}
            </View>
          </View>
