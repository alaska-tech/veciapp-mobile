    ...
    >
      <BottomSheetView style={{ flex: 1, padding: 16 }}>
        ...
        <TouchableOpacity
          ...
          className={`flex-row items-center p-4 ${selectedMethod === 'online' ? 'bg-[#00563B]' : 'bg-gray-100'} rounded-full mb-4`}
        >
          <CreditCard size={24} color={selectedMethod === 'online' ? 'white' : '#666666'} />
          <Text className={`${selectedMethod === 'online' ? 'text-white' : 'text-gray-700'} text-lg ml-3 flex-1`}>
        ...
        <TouchableOpacity
          ...
          className={`flex-row items-center p-4 ${selectedMethod === 'cash' ? 'bg-[#00563B]' : 'bg-gray-100'} rounded-full`}
        >
          <HandshakeIcon size={24} color={selectedMethod === 'cash' ? 'white' : '#666666'} />
          <Text className={`${selectedMethod === 'cash' ? 'text-white' : 'text-gray-700'} text-lg ml-3 flex-1`}>
