  ...
  return (
    ...
    >
      <View className="flex-1 min-h-screen items-center justify-center px-4">
        <Text className="text-3xl font-bold text-green-900 text-center mb-6">
          ¡Listo, tu compra fue un éxito!
        </Text>
        <Card className="w-full max-w-xl mb-8 bg-white rounded-2xl shadow-lg">
          <View className="p-6">
            <Text className="text-lg font-bold mb-4 text-center">
              ¿Qué te pareció la compra?
            </Text>
            <View className="flex-row items-center justify-center mb-2">
              <Image
                source={{
                  uri: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=80&q=80",
                }}
                className="w-8 h-8 rounded-full mr-2"
              />
              <Text className="text-base font-medium">
                Jabon artesanal coco y miel
              </Text>
            </View>
            ...
            <Text className="text-sm font-semibold mb-1">
              Cuéntanos acerca de tu experiencia{" "}
        ...
        <View className="w-full max-w-xl mb-4">
          <View className="bg-black rounded-2xl py-5 mb-4">
            <Text className="text-white text-center text-lg font-semibold">
              Gracias por ser parte del vecindario
            </Text>
          </View>
          <View className="bg-white rounded-2xl py-5 mb-4 items-center">
            <Text className="text-center text-base mb-2">
              En <Text className="font-bold">{counter} segundos</Text> seras
              redirigido al chat con tu veciproveedor
            </Text>
          </View>
          <Button
